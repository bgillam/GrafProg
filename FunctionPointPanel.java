/**
 * GetPointPanel input panel for shape types
 * 
 * @author (Bill Gillam) 
 * @version (1/12/2017)
 */
...
public class FunctionPointPanel extends JPanel
{
    ...
    FunctionPointPanel gpp = new FunctionPointPanel(GrafType.SCATTER, new ArrayList<GrafObject>());
         gpp.setVisible(true);
     ...
     */
    public FunctionPointPanel(GrafType gTypePassed, ArrayList<GrafObject> tempListPassed)
    {
    ...
    public void initFx(){
       if (!(fComboBox.getItemCount()==0)) f.setText((String)fComboBox.getItemAt(0)) ;
       }
